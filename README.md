...
This repo includes code for basic Electron login system and data persistence using electron-settings package. The electron-settings package provides api that has functionality similar to the web browser localStorage, so makes it easier for web developoers to use it and apply the user data persistence and authentication.
